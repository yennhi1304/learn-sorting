...
/* Let the chatbot read the whole page */
async function sendMessage() {
  const userMessage = document.getElementById("chat-input").value;
  const pageInfo = document.body.innerText;   // whole page text

  const res = await fetch("https://yourserver.onrender.com/chat", {
    method: "POST",
    headers: { "Content-Type": "application/json" },
    body: JSON.stringify({
      message: userMessage,
      webpageData: pageInfo
    })
  });
